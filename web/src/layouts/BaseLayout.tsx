          ...
          <div className="flex flex-col-reverse items-start justify-between gap-4 md:flex-row">
            <div className="flex flex-col gap-4">
              <h4 className="text-4xl">
                International Women's Day Nigeria 2022
              </h4>

              <p>
                IWD Nigeria 2022 Summit is a celebration for all women in
                technology. Women and allies from all across the country come
                together to empower, inspire and learn from each other. This
                year we are focused on recognizing our theme Progress Not
                Perfection.
              </p>
          ...
          <div className="flex flex-col items-center justify-center gap-6 md:flex-row">
            ...
            <div className="w-full">
              ...
              <p>
                ...
                hold us back from following our dreams. So often we hold
                ourselves to impossibly high standards and feel disappointed
                when we can’t reach them - or worse, we don’t even try. When we
                let the idea of being perfect go, we allow ourselves the space
                and freedom to try new things, to make mistakes and to learn. We
                see that all of our experiences - the good, the bad, and the
                ugly - have made us who we are today. Instead of striving for
                perfection, we can strive for growth and discovery. Instead of
                being fixated on the destination, we enjoy the journey, wherever
                it takes us.
              </p>
        ...
        <section>
          <div className="flex flex-col items-start justify-center gap-4 md:flex-row">
            <div className="flex w-3/5 flex-col gap-4 rounded-2xl bg-white p-4">
              ...
              <p>
                We are looking for passionate speakers who can give a talk at
                our event. Please do fill the form if you are interested. Our
                team will get in touch with you after reviewing your entry.
              </p>
            ...
            <div className="flex w-full flex-col gap-4 rounded-2xl bg-white p-4">
              ...
              <p>
                ...
                women and allies all over the world. Women Ambassadors from
                across India had gotten together to showcase exemplary teamwork,
                a passion to win and the courage to create something that hadn't
                been done before. The event was a phenomenal success, but the
                best part was that it brought out the sisterhood between
                communities. Together, we all rose. The team had tons of
                learnings and are now all set to make IWD India 2022 all the
                more worthy of your time. Stay tuned for a bigger, better and a
        ...
        <section className="py-10">
          <div className="mx-auto flex w-3/4 flex-col items-center justify-center gap-2">
            <h4 className="text-center text-3xl font-bold">
              Keep in touch with{" "}
              <span className="text-blue-600">#IWDIndia2022</span> for the
